...
internal static class NativeLocalization
{
    ...
    public static string Translate(string? setting, string key) => (Resolve(setting), key) switch
    {
        ...
        ("zh", "WebView2 runtime missing") => "未安装 Microsoft Edge WebView2 Runtime。请安装 Evergreen Runtime 后重新启动应用。",
        ...
        ("ja", "WebView2 runtime missing") => "Microsoft Edge WebView2 Runtime がインストールされていません。Evergreen Runtime をインストールしてから再起動してください。",
